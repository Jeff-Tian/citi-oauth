  ...
  it('should apply', async () => {
    ...
    const data = {
      ApplicationAddRequest: {
        ...
        applicant: {
          ocr: {ocrReferenceNumber: 'OCR456789434538922'},
          motherMaidenName: 'Lisa',
          name: {
            salutation: 'MR',
            givenName: 'Matthew',
          ...
          contactConsent: {okToCall: true, okToMail: true, okToSms: true},
          financialInformation: {
            hasForeseeableFinancialChanges: true,
            expenseDetails: [
              {
          ...
          consentDetails: [
            ...
            {consentType: 'PARTNER_CONSENT', isConsentGiven: true},
          ],
          selfDeclaration: {
            totalActiveCreditCardLimitAmount: 23000.25,
            anticipatedIncomeDecreaseCode: 'Yes',
    ...
    console.log('res = ', res.data.moreInfo)
